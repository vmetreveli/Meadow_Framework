...
public static class MiddlewareUtils
{
    ...
    ///     An optional dictionary that maps exception types to HTTP status codes.
    ///     If <c>null</c> a new empty dictionary will be used and the middleware will rely on its defaults.
    /// </param>
