...
using Meadow.Framework.Domain.Abstractions.Specifications;

namespace Meadow.Framework.Infrastructure.Infrastructure.Specifications;
...
{
    /// <summary>
    ///     Applies the given <see cref="IQueryable{T}" /> to the provided <see cref="TEntity" />.
    /// </summary>
    /// <typeparam name="TId">The type of the entities in the query.</typeparam>
    /// <typeparam name="TId">The type of the entity's identifier.</typeparam>
    /// <param name="specification">The initial queryable to which the specification will be applied.</param>
    /// <param name="specification">The specification containing criteria, includes, ordering, and tracking information.</param>
    /// <returns>An <see cref="Specification{TEntity,TId}" /> that reflects the applied specification.</returns>
